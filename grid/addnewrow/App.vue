<template>
    <div>
        ...
        <JqxRadioButton :theme="'material'" @checked="btnTopOnChecked()" :checked="true">Add New Row to Top</JqxRadioButton>

        <JqxRadioButton :theme="'material'" @checked="btnBottomOnChecked()">Add New Row to Bottom</JqxRadioButton>
    </div>
</template>
