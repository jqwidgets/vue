<template>
    <JqxDocking :theme="'material'" :orientation='"horizontal"' :width="getWidth" :mode="'docked'" :rtl="true">
        <div>
            <div id="window1" style="height: 220px;">
                ...
                <div style="overflow: hidden;">
                    <JqxCalendar :theme="'material'" :width="180" :height="180" :rtl="true" style="float: left; margin-right: 10px;">
                    </JqxCalendar>
            ...
            <div id="window2" style="height: 220px">
                ...
                <div style="overflow: hidden;">
                    <JqxTabs :theme="'material'" :width="350" :height="181" :selectedItem="1" :rtl="true">
        ...
        <div>
            <div id="window3" style="height: 220px">
                ...
                <div style="overflow: hidden;">
                    <JqxPanel :theme="'material'" :width="'100%'" :height="180" :rtl="true">
            ...
            <div id="window4" style="height: 220px;">
                ...
                <div style="overflow: hidden;">
                    <JqxListBox :theme="'material'" :width="'100%'" :height="181" :source="source" :rtl="true">
                    </JqxListBox>
                </div>
            </div>
        </div>
