<template>
    <JqxFileUpload :theme="'material'" :width="300" :uploadUrl="'upload.php'" :fileInputName="'fileToUpload'" :renderFiles="renderFiles">
    </JqxFileUpload>
</template>
        ...
        methods: {
            renderFiles: function (fileName) {
                ...
                if (this.imageTypes.indexOf(extension) !== -1) {
                    iconUrl = 'https://www.jqwidgets.com/vue/images/nav3.png';
                } else if (this.videoTypes.indexOf(extension) !== -1) {
                    iconUrl = 'https://www.jqwidgets.com/vue/images/movie.png';
                } else {
                    iconUrl = 'https://www.jqwidgets.com/vue/images/nav1.png';
                }
