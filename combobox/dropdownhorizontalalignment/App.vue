<template>
    <div>
        <div style="float: left; font-size: 13px; font-family: Verdana;">
            ...
            <JqxRadioButton :theme="'material'" @checked="leftBtnOnChecked()">
                Left
            </JqxRadioButton>

            <JqxRadioButton :theme="'material'" style="margin-top: 10px" @checked="rightBtnOnChecked()" :checked="true">
                Right
            </JqxRadioButton>

        </div>

        <JqxComboBox :theme="'material'" ref="myComboBox" style="float: left; margin-top: 20px; margin-left: 100px;"
