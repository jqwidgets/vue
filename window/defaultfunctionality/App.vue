<template>
    <div id="jqxWidget">
        ...
        <JqxWindow ref="window"
            ...
            <div>
                <span>
                    <img src="https://www.jqwidgets.com/vue/images/movie.png" alt="" style="margin-right: 15px" />Movies
                </span>
            </div>
            <div>
                <JqxTabs ref="tab" :autoCreate="false">
                    ...
                    <div>
                        <img src="https://www.jqwidgets.com/vue/images/avatar.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="https://www.jqwidgets.com/vue/images/endgame.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="https://www.jqwidgets.com/vue/images/twilight.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="https://www.jqwidgets.com/vue/images/unstoppable.png" style="float: left; margin: 10px;" alt="" />
                    ...
                    <div>
                        <img src="https://www.jqwidgets.com/vue/images/priest.png" style="float: left; margin: 10px;" alt="" />
